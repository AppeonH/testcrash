$PBExportHeader$w_taetigkeiten_vst.srw
$PBExportComments$Tätigkeitenerfassung für Vorstandstab
forward
global type w_taetigkeiten_vst from w_taetigkeiten_basis
end type
type uo_zeitraum from u_auswahl_zeitraum within w_taetigkeiten_vst
end type
type cb_wechsel from commandbutton within w_taetigkeiten_vst
end type
type cb_ok from commandbutton within w_taetigkeiten_vst
end type
type dw_tk_single from datawindow within w_taetigkeiten_vst
end type
type dw_tk_liste_cross from datawindow within w_taetigkeiten_vst
end type
type dw_tk_liste_grid from datawindow within w_taetigkeiten_vst
end type
type cb_new_umlage from commandbutton within w_taetigkeiten_vst
end type
type cb_delete from commandbutton within w_taetigkeiten_vst
end type
end forward
...
global w_taetigkeiten_vst w_taetigkeiten_vst
...
type dw_zeitdaten from w_taetigkeiten_basis`dw_zeitdaten within w_taetigkeiten_vst
integer x = 3017
integer y = 0
integer height = 2120
end type
...
type dw_info from w_taetigkeiten_basis`dw_info within w_taetigkeiten_vst
integer x = 50
integer width = 2935
end type

type ds_schluessel from w_taetigkeiten_basis`ds_schluessel within w_taetigkeiten_vst
end type
...
integer taborder = 40
string title = "none"
string dataobject = "d_tk_single_vst"
...
if dwo.name = "u_p" then
	...
	// Umlage für VST nur für Projekt, Beratung oder Kostenträger auswählbar
